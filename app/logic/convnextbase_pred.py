...
# Object that will detect faces for us
# detector = dlib.cnn_face_detection_model_v1(
#     os.path.join(os.getcwd(), "app", "model", "mmod_human_face_detector.dat"))
# detector = MTCNN()
...
model.load_weights(
    os.path.join(MODEL_DIR, "convnextbase_face_recognition_model.keras"))
